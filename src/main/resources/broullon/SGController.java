...
////////////////////////////////////DEBUT DES REQUETES DE TYPE GET ////////////////////////////////////////////
	...
	@GetMapping(path="/getdonneesSaisieRAbsence")
	public String getdonneesSaisieRAbsence(Model model, HttpServletRequest request){
		
		this.constructModelgetdonneesSaisieRAbsences(model,	request);
		
		return "users/donneesSaisieRAbsence";
	}
	...
	public void constructModelgetformSaisieRAbsence(Model model,	HttpServletRequest request, Long idSequenceConcerne,  Long idClassesConcerne,  
			Long idEleves,  int numPageEleves, int taillePage ){
	...
	public String getformSaisieRAbsence(
			Model model, HttpServletRequest request,
			@RequestParam(name="idSequenceConcerne", defaultValue="-1") Long idSequenceConcerne,
			@RequestParam(name="idClassesConcerne", defaultValue="0") Long idClassesConcerne,
			@RequestParam(name="idEleves", defaultValue="0") Long idEleves,
		...
		this.constructModelgetformSaisieRAbsence(model,	request, idSequenceConcerne, idClassesConcerne,  
				idEleves, numPageEleves, taillePage);
		
		return "users/formSaisieAbsence";
	}
	...
	public String getUpdateRAbsence(
		...
		try{
			...
			if(ret == 0) return "redirect:/logesco/users/sg/getformSaisieRAbsence?updateRDisciplineError"
			...
			e.printStackTrace();
			return "redirect:/logesco/users/sg/getformSaisieRAbsence?updateRDisciplineErrorConvert"
					+ "&&idSequenceConcerne="+idSequenceConcerne
					+ "&&idClassesConcerne="+idClassesConcerne;
		}
		
		
		return "redirect:/logesco/users/sg/getformSaisieRAbsence?updateRDisciplineSuccess"
				+ "&&idSequenceConcerne="+idSequenceConcerne
				+ "&&idClassesConcerne="+idClassesConcerne;
